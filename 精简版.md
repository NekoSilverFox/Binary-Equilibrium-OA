...
$$
\overrightarrow{C_i^{\text {initial }}}=\overrightarrow{C_{\min }}+\overrightarrow{\text { rand }}_i\left(\overrightarrow{C_{\max }}-\overrightarrow{C_{\min }}\right) \quad i=1,2, \cdots . . n
...
- $\overrightarrow{\text { rand }}_i$ 是一个在0和1之间随机产生的数字
